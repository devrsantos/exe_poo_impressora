...
public class ImpressoraCanon extends Impressora{
    ...
    public ImpressoraCanon(String modelo, String tipoConexao, LocalDate dataFabricacao, int folhasDisponiveis, double percTinta) {
    ...
    public void imprimir() {
        if (temPapel() && !precisaTinta()) {
            ...
            System.out.println("Imprimindo com a impressora Canon ...");
